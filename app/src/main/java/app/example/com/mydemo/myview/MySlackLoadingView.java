...
public class MySlackLoadingView extends View {
    ...
    public MySlackLoadingView(Context context) {
        this(context, null);
    }

    public MySlackLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySlackLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
